...
describe('calculateBillSplit', () => {
  it('splits basic costs between multiple users', () => {
    const bill = createBill([
      { id: 1, billId: 1, nameOriginal: 'A', nameEnglish: 'A', quantity: 1, priceTotal: 10 },
      { id: 2, billId: 1, nameOriginal: 'B', nameEnglish: 'B', quantity: 1, priceTotal: 20 },
    ]);
  ...
  it('handles item quantities and partial votes', () => {
    const bill = createBill([
      { id: 1, billId: 1, nameOriginal: 'C', nameEnglish: 'C', quantity: 3, priceTotal: 9 },
    ]);
  ...
  it('collects items without votes into unvotedItems', () => {
    const bill = createBill([
      { id: 1, billId: 1, nameOriginal: 'A', nameEnglish: 'A', quantity: 1, priceTotal: 5 },
      { id: 2, billId: 1, nameOriginal: 'B', nameEnglish: 'B', quantity: 1, priceTotal: 5 },
    ]);
