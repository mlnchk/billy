...
// Generated by Wrangler by running `wrangler types` (hash: 4ef3d550455f747aa6f9ba23e4e8d3d8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_TOKEN" | "GOOGLEAI_API_KEY">> {}
}
